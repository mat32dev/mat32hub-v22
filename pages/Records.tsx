  ...
  return (
    <div className="min-h-screen bg-mat-900 pb-24">
      ...
      <div className="bg-mat-950 py-32 md:py-52 border-b border-mat-800 relative overflow-hidden text-center">
        ...
        <p className="text-gray-500 text-xl mt-8 italic opacity-80 max-w-2xl mx-auto px-6 relative z-10 font-light leading-relaxed">Selección técnica para audiófilos.</p>
      </div>
