  ...
  return (
    <div className="min-h-screen bg-mat-900 flex flex-col font-sans">
      <SEO 
        ...
        descriptionKey="Reserva tu mesa en el mejor bar Hi-Fi de Valencia. Localización en Ruzafa y contacto directo para eventos culturales." 
      />
      
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://lrilkrktztlabjpxqbyc.supabase.co/storage/v1/object/public/local-gallery/PORTADA_2_mat32.jpg" alt="Mat32 Valencia" className="w-full h-full object-cover opacity-30 grayscale" />
          ...
          <div className="lg:col-span-5 space-y-12">
             <div className="space-y-12">
                ...
                <div className="flex items-start gap-6 group">
                   ...
                   <div>
                      <h4 className="text-[10px] font-black text-mat-500 uppercase tracking-[0.4em] mb-4">HORARIO</h4>
                ...
                <form onSubmit={handleBookingSubmit} className="space-y-6">
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                         ...
                         <input name="name" value={bookingForm.name} onChange={handleBookingChange} className={`w-full bg-mat-900 border p-5 text-white uppercase text-[10px] font-black rounded-2xl focus:border-mat-500 outline-none transition-all ${errors.name ? 'border-red-500 bg-red-500/5' : 'border-mat-700'}`} placeholder="TU ALIAS" />
                      ...
                      <div className="space-y-2">
                         ...
                         <input name="email" type="email" value={bookingForm.email} onChange={handleBookingChange} className={`w-full bg-mat-900 border p-5 text-white font-black text-[10px] rounded-2xl focus:border-mat-500 outline-none transition-all ${errors.email ? 'border-red-500 bg-red-500/5' : 'border-mat-700'}`} placeholder="EMAIL@HUB.COM" />
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                      <div className="space-y-2">
                         ...
                         <input type="date" name="date" value={bookingForm.date} onChange={handleBookingChange} className={`w-full bg-mat-900 border p-5 text-white uppercase text-[10px] font-black rounded-2xl focus:border-mat-500 outline-none transition-all ${errors.date ? 'border-red-500 bg-red-500/5' : 'border-mat-700'}`} />
                      ...
                      <div className="space-y-2">
                         ...
                         <select name="time" value={bookingForm.time} onChange={handleBookingChange} className="w-full bg-mat-900 border border-mat-700 p-5 text-white text-[10px] font-black rounded-2xl cursor-pointer">
                      ...
                      <div className="space-y-2">
                         ...
                         <select name="guests" value={bookingForm.guests} onChange={handleBookingChange} className="w-full bg-mat-900 border border-mat-700 p-5 text-white text-[10px] font-black rounded-2xl cursor-pointer">
                   ...
                   <button type="submit" disabled={bookingStatus === 'submitting'} className="w-full py-8 bg-mat-500 hover:bg-mat-400 text-white font-black uppercase tracking-[0.4em] text-[11px] rounded-[2rem] shadow-2xl flex items-center justify-center gap-4 transition-all group mt-6 shadow-mat-500/20">
                      {bookingStatus === 'submitting' ? <Loader2 className="animate-spin" /> : <Send />} ENVIAR SOLICITUD_HUB
                   </button>
                </form>
             </div>
          </div>
      ...
      {bookingStatus === 'success' && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-6 bg-black/95 backdrop-blur-2xl animate-fade-in">
           <div className="w-full max-w-md bg-mat-900 border-2 border-emerald-500 p-12 rounded-[4rem] text-center shadow-[0_0_100px_rgba(16,185,129,0.2)] relative">
              ...
              <p className="text-gray-400 italic mb-10 leading-relaxed text-sm">
                Tu señal ha sido inyectada. Te responderemos desde <strong>hola@mat32.com</strong>.
              </p>
              <button onClick={() => setBookingStatus('idle')} className="w-full py-5 bg-emerald-500 text-white font-black uppercase tracking-widest rounded-2xl shadow-xl hover:bg-emerald-400 transition-all clip-path-slant">ENTENDIDO</button>
           </div>
        </div>
      )}
    </div>
